...
This section explains how to set up Travis to test a repoistory with a single application. See https://github.com/rstudio/shinytest-ci-example for an example.
